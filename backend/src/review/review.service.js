...
var ReviewService = function () {
    ...
    var ReviewService = _classThis = /** @class */ (function () {
        function ReviewService_1(cardRepo) {
            this.cardRepo = cardRepo;
        }
        // 提交复习结果
        ReviewService_1.prototype.review = function (userId, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var card;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.cardRepo.findOne({ where: { id: dto.cardId }, relations: ['owner'] })];
                        case 1:
                            card = _a.sent();
                            if (!card)
                            ...
                            (0, sm2_1.applySM2)(card, dto.grade);
                            return [4 /*yield*/, this.cardRepo.save(card)];
                        case 2:
                            _a.sent();
                            return [2 /*return*/, {
                                    id: card.id,
