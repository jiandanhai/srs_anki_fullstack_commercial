...
var ReviewController = function () {
    var _classDecorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Controller)('api/review')];
    ...
    var ReviewController = _classThis = /** @class */ (function () {
         ...
         */
        ReviewController_1.prototype.review = function (req, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    userId = req.userId;
                    return [2 /*return*/, this.reviewService.review(userId, dto)];
                });
            });
        };
    ...
    (function () {
        ...
        _review_decorators = [(0, common_1.Post)()];
