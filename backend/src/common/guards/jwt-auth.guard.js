...
/**
 * 简单的 JWT Guard（非 passport 实现）
 * - 从 Authorization: Bearer <token> 中取 token
 * - 使用 UsersService.verifyJwt 校验 token
 * - 将 userId 写入 req.userId，供 controller 使用
 * 注意：Nest 的 Guard 是通过依赖注入创建的，上面 JwtAuthGuard 依赖 UsersService。
 * 在 AppModule 或在全局 providers 中要确保 UsersService 可注入（上面 UsersModule 已导出 UsersService）。
 */
var JwtAuthGuard = function () {
    ...
    var JwtAuthGuard = _classThis = /** @class */ (function () {
        function JwtAuthGuard_1(usersService) {
            this.usersService = usersService;
        }
        JwtAuthGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var req, auth, parts, token, payload;
                var _a;
                return __generator(this, function (_b) {
                    ...
                    token = parts[1];
                    try {
                        payload = this.usersService.verifyJwt(token);
