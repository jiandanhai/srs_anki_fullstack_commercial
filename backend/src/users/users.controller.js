...
var UsersController = function () {
    var _classDecorators = [(0, common_1.Controller)('api/users')];
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.register = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.usersService.createUser(dto)];
                        case 1:
                            user = _a.sent();
        ...
        UsersController_1.prototype.login = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                var user, token;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.usersService.validateUser(dto.username, dto.password)];
                        case 1:
                            user = _a.sent();
                            if (!user)
                                throw new common_1.BadRequestException('用户名或密码错误');
                            token = this.usersService.generateJwt(user);
                            return [2 /*return*/, {
                                    success: true,
                                    data: {
        ...
        // 获取当前登录用户信息
        UsersController_1.prototype.me = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                var user, _a, passwordHash, rest;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.usersService.findById(req.userId)];
                        case 1:
                            user = _b.sent();
                            if (!user)
                                throw new common_1.BadRequestException('User not found');
                            _a = user, passwordHash = _a.passwordHash, rest = __rest(_a, ["passwordHash"]);
                            return [2 /*return*/, { success: true, user: rest }];
                    }
                });
            });
        };
    ...
    (function () {
        ...
        _login_decorators = [(0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, common_1.Post)('login')];
