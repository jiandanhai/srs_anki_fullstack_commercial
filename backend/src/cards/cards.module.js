...
var card_entity_1 = require("./entities/card.entity");
var cards_service_1 = require("./cards.service");
var cards_controller_1 = require("./cards.controller");
var users_module_1 = require("../users/users.module");
var CardsModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [typeorm_1.TypeOrmModule.forFeature([card_entity_1.Card]), users_module_1.UsersModule],
